...
import com.kevingt.moviebrowser.util.loadImage
...
class DiscoverAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        (holder as MovieViewHolder).itemView.apply {
            ...
            iv_discover_poster.loadImage(data[position].poster_path)
            iv_discover_back.loadImage(data[position].backdrop_path)
        }
    }
